...
class CharacterCpt extends React.Component {
  ...
  render(){
    return (
      <div
        onMouseOver={() => this.setState(() => {return {height:200, barHeight:39, text:"100/100 PV"}})}
        ...
        <div style={{display: 'flex'}}>
         ...
         <div style={{display:'flex', width:160, flexDirection:'column', height:45}}>
           ...
           <Bar max={100} value={100} text={this.state.text} style={{display:'flex', flex:1, height:this.state.barHeight, width:130, marginTop:3}} />
         </div>
        </div>
