...
class NavBarCpt extends React.Component {
  render(){
    return (
      <div className="wood" style={{display: 'flex', height:50, marginLeft:20, marginRight:20, backgroundColor:'#DDCCAA', alignItems: 'center', borderWidth: 3, borderStyle: 'solid', borderColor: '#000000', borderRadius: 15, overflow:'hidden'}}>
        <div style={{display:'flex', zIndex:400, position:'absolute', top:0, left:20, right:20, bottom:0, height:50}}>
          ...
          <div style={{display:'flex', alignSelf:'flex-start', alignItems:'center', marginLeft:10, height:50, overflow:'auto',}}>
            <button style={{display:'flex', height: 40, width:150, alignItems:'center', borderRadius:10, fontSize:16, backgroundColor:'#333333', color:'#FFFFFF'}} onClick={() => console.log('hola')}>
            ...
            <button style={{display:'flex', height: 40, width:150, alignItems:'center', borderRadius:10, fontSize:16, backgroundColor:'#333333', color:'#FFFFFF'}} onClick={() => this.props.onDisconnect()}>
